...
import { Card, CardContent, Typography, Box, CardActionArea, Avatar} from "@mui/material";
      ...
      >
          ...
          >
            <Box sx={{ width: '100%', display: 'flex', flexDirection: 'column', flexGrow: 1 }}>
              ...
              <Stack direction="row" alignItems="center" justifyContent="space-between" mt="auto" width="100%">
                  <Stack direction="row" alignItems="center" spacing={1}>
                    <Avatar
                      ...
                      <Typography variant="caption" color="text.secondary" fontWeight={500} noWrap sx={{ maxWidth: 100 }}>
